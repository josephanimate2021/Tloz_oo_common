...
def build_location_name_to_id_dict(LOCATIONS_DATA) -> Dict[str, int]:
...
def build_item_name_to_id_dict(ITEMS_DATA) -> Dict[str, int]:
...
def build_item_id_to_name_dict(ITEMS_DATA) -> Dict[int, str]:
